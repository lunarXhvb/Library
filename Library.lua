...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfile(("LUNAR/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("LUNAR/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("LUNAR/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("LUNAR/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("LUNAR/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	ResizeDot.Position = UDim2.new(1, -10, 1, -10);
	ResizeDot.AnchorPoint = Vector2.new(0.5, 0.5);
	ResizeDot.Size = UDim2.new(0, 12, 0, 12);
	ResizeDot.BackgroundColor3 = Color3.fromRGB(100, 100, 100);
	...
	if not UserInputService.TouchEnabled then
		...
		ResizeDot.MouseLeave:Connect(function()
...
function main:Button(text, callback)
	...
	ImageLabel.Parent = Button; -- Changed parent to Button instead of TextButton
	ImageLabel.BackgroundColor3 = _G.Primary;
	ImageLabel.BackgroundTransparency = 1;
	ImageLabel.AnchorPoint = Vector2.new(0.5, 0.5);
	ImageLabel.Position = UDim2.new(1, -12.5, 0.5, 0); -- Moved to right side
	ImageLabel.Size = UDim2.new(0, 15, 0, 15);
	ImageLabel.Image = "rbxassetid://10734898355";
	ImageLabel.ImageTransparency = 0;
	ImageLabel.ImageColor3 = Color3.fromRGB(255, 255, 255);
	
	-- Remove the old TextButton since we're using ClickableButton now
	...
	-- Connect the click event to the whole button
	ClickableButton.MouseButton1Click:Connect(function()
		callback();
	end);
end;
